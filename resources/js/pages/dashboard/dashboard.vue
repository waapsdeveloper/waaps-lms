                ...
                <div class="col-lg-4 col-md-6 grid-item marketing">
                    <div class="single-course-item">
                        ...
                        <div class="hover-state">
                            ...
                            <p class="margin-top-20">Learn WordPress like a Professional! Start from the basics and go all
                                the way to creating your own applications and website!</p>
                ...
                <div class="col-lg-4">
                    <div class="about-content-left">
                        <div class="about-single-content">
                            ...
                            <p class="margin-top-10">Explore a variety of fresh topics Podcasting better management inside
                                workflows.</p>
                        </div>
                        <div class="about-single-content">
                            <div class="content-top">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-single-item">
                        <div class="single-blog-image">
                            <a href="#"><img src="assets/images/news-1.jpg" alt="blog"></a>
                        </div>
                        <div class="blog-meta">
                            <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-single-item">
                        <div class="single-blog-image">
                            <a href="#"><img src="assets/images/news-2.jpg" alt="blog"></a>
                        </div>
                        <div class="blog-meta">
                            <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-single-item">
                        <div class="single-blog-image">
                            <a href="#"><img src="assets/images/news-3.jpg" alt="blog"></a>
                        </div>
                        <div class="blog-meta">
                            <ul>
