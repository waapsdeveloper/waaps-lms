              ...
              <div class="tab">
                <ul>
                  ...
                  <li class="tab-second-00" :class="{ active: auth.role == 'instructor'}">
                    <a
                      @click="auth.role = 'instructor'"
                      class="template-button-2"
                      >instructor</a
                    >
                  </li>
                  <li class="tab-three-00" :class="{ active: auth.role == 'student'}">
                    <a @click="auth.role = 'student'"  class="template-button-2"
                      >student</a
                    >
                  </li>
                </ul>
                ...
                <form action="#">
                  <div class="form-group">
                    <label for="signupName"
                      ><i class="fa fa-user"></i> Your Name</label
                    >
                  ...
                  <div class="login-button margin-top-20">
                    <a @click="validate" class="template-button"
                      >Create account</a
                    >
                    <span
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          ...
          <div class="cta-button">
            <a href="/about" class="template-button margin-right-20"
              >start teaching</a
            >
