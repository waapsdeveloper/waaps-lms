            ...
            <div class="col-lg-12 col-xl-12 col-xxl-6 mb-5 mb-xl-0">
                  ...
                  <div class="tab-content mb-2 px-9">
                    ...
                    >
                      ...
                      <div class="d-flex align-items-center mb-6">
                        ...
                        <span
                          ...
                          class="bullet bullet-vertical d-flex align-items-center min-h-70px mh-100 me-4 bg-success"
                        ></span>
                        <!--end::Bullet-->
                        <!--begin::Info-->
                      ...
                      <div class="d-flex align-items-center mb-6">
                        ...
                        <span
                          data-kt-element="bullet"
                          class="bullet bullet-vertical d-flex align-items-center min-h-70px mh-100 me-4 bg-warning"
                        ></span>
                        <!--end::Bullet-->
                        <!--begin::Info-->
                        <div class="flex-grow-1 me-5">
                    ...
                    >
                      ...
                      <div class="d-flex align-items-center mb-6">
                        ...
                        <span
                          data-kt-element="bullet"
                          class="bullet bullet-vertical d-flex align-items-center min-h-70px mh-100 me-4 bg-danger"
                        ></span>
                        <!--end::Bullet-->
                        <!--begin::Info-->
                        <div class="flex-grow-1 me-5">
              ...
              <div class="card card-flush d-none h-md-100">
                ...
                <div class="card-body p-0">
                  <!--begin::Dates-->
                  <ul
                    class="nav nav-pills d-flex flex-nowrap hover-scroll-x py-2 ms-4"
                  >
                    <!--begin::Date-->
                    ...
                    <div class="col-sm-6 mb-10 mb-sm-0">
                      ...
                      <div
                        ...
                        style="
                          ...
                          background-image: url('assets/media/stock/600x600/img-33.jpg');
                        "
                      ></div>
                      <!--end::Image-->
                    </div>
                      ...
                      <div class="table-responsive mx-9 mt-n6">
                        ...
                        <table class="table align-middle gs-0 gy-4">
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <a href="#" class="text-gray-600 fw-bold fs-6"
                                  >2:30 PM</a
                                >
                              </td>
                  ...
                  >
                    ...
                    <li class="nav-item p-0 ms-0">
                      ...
                      >
                        ...
                        <!--begin::Bullet-->
                        <span
                          class="bullet-custom position-absolute z-index-2 w-100 h-1px top-100 bottom-n100 bg-primary rounded"
                        ></span>
                        <!--end::Bullet-->
                      </a>
                    </li>
