                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <a href="../../demo1/dist/apps/projects/list.html"
                            class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary">My Projects</a>
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                                    ...
                                    <div class="col-sm-7 pe-0 mb-5 mb-sm-0">
                                        ...
                                        <div
                                            ...
                                            <div class="mb-7">
                                                <!--begin::Title-->
                                                <div class="mb-6">
                                                    <h3 class="fs-2x fw-semibold text-white">Complete Your Task</h3>
                                                    <span class="fw-semibold text-white opacity-75">To upgrade your level</span>
                                                </div>
                                                <!--end::Title-->
                                                <!--begin::Items-->
                                            ...
                                            <!--begin::Action-->
                                            <div class="m-0">
                                                <a @click="route('/level-one')"
                                                    class="btn btn-color-white bg-white bg-opacity-15 bg-hover-opacity-25 fw-semibold"
                                                    data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Start Task</a>
                                            </div>
                                            <!--begin::Action-->
                                        </div>
                                        <!--end::Wrapper-->
                    ...
                    <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                                            ...
                                            <div class="d-flex flex-column h-100">
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <span class="fw-semibold text-gray-600 fs-6 mb-8 d-block">Flat cartoony
                                                        illustrations with vivid unblended
                        ...
                        <div class="col-xxl-6">
                            ...
                            <div class="card border-0 h-md-100" data-theme="light" style="
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center h-100">
                                        ...
                                        <div class="col-7 ps-xl-13">
                                            ...
                                            <!--end::Title-->
                                            <!--begin::Text-->
                                            <span class="fw-semibold text-white fs-6 mb-8 d-block opacity-75">Flat cartoony
                                                and illustrations with vivid unblended
