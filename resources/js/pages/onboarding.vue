        ...
        <div class="d-flex flex-center flex-column flex-column-fluid">
          ...
          <div class="w-lg-650px w-xl-700px p-10 p-lg-15 mx-auto">
            ...
            <form
              ...
              data-kt-redirect-url="../../demo1/dist/account/overview.html"
            >
              <!--begin::Step 1-->
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        ...
                        >
                          ...
                          <span class="d-block fw-semibold text-start">
                            <span class="text-dark fw-bold d-block fs-4 mb-2"
                              >Instructor Account</span
                            >
                            <span>Press Continue, to become a Instructor</span>
                          </span>
                          <!--end::Info-->
                        </label>
                        <!--end::Option-->
              ...
              <div class="" data-kt-stepper-element="content">
                ...
                <div class="w-100">
                  ...
                  <div class="pb-10 pb-lg-15">
                    <!--begin::Title-->
                    <h2 class="fw-bold text-dark">Account setting</h2>
                    <!--end::Title-->
                    <!--begin::Notice-->
                  ...
                  <div class="mb-10 fv-row">
                    <!--begin::Label-->
                    <label class="form-label mb-3 required">Cv Link</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input
                      type="text"
              ...
              <div class="" data-kt-stepper-element="content">
                ...
                <div class="w-100">
                  ...
                  <div class="fv-row mb-10">
                    ...
                    <!--begin::Input-->
                    <input
                      name="previous_experience_technologies"
                      class="form-control form-control-lg form-control-solid"
                      value=""
                    />
                    <!--end::Input-->
                  ...
                  <div class="fv-row mb-10">
                    <!--begin::Label-->
                    <label class="form-label required">Previous Experience Technologies <i>(no.of years)</i></label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input
                      name="previous_experience_technologies_years"
                      class="form-control form-control-lg form-control-solid"
                      value=""
                    />
                    <!--end::Input-->
              ...
              <div class="d-flex flex-stack pt-15">
                ...
                <div>
                  ...
                  >
                    <span class="indicator-label" @click="route('/profile')"
                      >Submit
