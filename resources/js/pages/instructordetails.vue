                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="breadcrumb-link margin-top-10">
                            <span><a href="/">home</a> / instructor details page</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="instructor-image">
                                <img src="/assets/images/instructor-details-image.jpg" alt="instructor">
                            </div>
                        </div>
                        <div class="col-lg-8">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="cta-button">
                            <a href="/signup" class="template-button margin-right-20">start teaching</a>
