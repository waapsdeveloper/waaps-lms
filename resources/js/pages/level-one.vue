                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <span class="card-toolbar">
                                        <a href="#" @click="route('/detail')"
                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm p-5 m-1"
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_create_project">Detail</a>
                                    </span>
